"""Bienvenido a la sección cinco, donde aprenderás sobre el módulo datetime y te familiarizarás con las clases de Python para trabajar con la fecha y la hora.
